...
//   const [inProgressItems, setInProgresstems] = useState([]);
...
//       setOnSaleItems(filterItemStatus(status.onSale));
//       setInStockItems(filterItemStatus(status.inStock));
//       setSoldItems(filterItemStatus(status.sold));
//       setInProgresstems(filterItemStatus(status.inProgress));
//       setItems(allItems);
//     };
//     fetchData();
//   }, []);

//   function filterItemStatus(status) {
//     const filteredItems = allItems.filter((item) => item.status === status);
//     return filteredItems;
//   }

//   function handleStatusClick(status) {
//     setItems(filterItemStatus(status));
//   }
